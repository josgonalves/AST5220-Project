...
class BackgroundCosmology{
  private:
    ...
    Spline t_of_x_spline{"Cosmic time"};
  ...
  public:
    ...
    double eta_prime_of_x(double x) const;
    ...
    // Get matter-radiation, matter-darkenergy equalities, start of acceleration
    double matter_radiation_equality() const;
    double matter_darkenergy_equality() const;
    double start_of_acceleration() const;
